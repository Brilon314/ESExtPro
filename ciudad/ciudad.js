...
console.log('localStorage.getItem("Gobernantes"):', localStorage.getItem("Gobernantes"));
console.log('localStorage.getItem("Politicas"):', localStorage.getItem("Politicas"));

if (localStorage.getItem("Gobernantes") === null && localStorage.getItem("Politicas") === null) {
