...
/*if ((localStorage.getItem("https://www.empire-strike.com/gobierno.php") != 'visited') && (localStorage.getItem("https://www.empire-strike.com/politica.php") != 'visited')) {
    GLOBAL.showError("<a href='/politica.php'>Politicas</a> y <a href='/gobierno.php'>Mapa/Gobierno</a> no cargados, sin optimizar al 100%");

} else if ((localStorage.getItem("https://www.empire-strike.com/politica.php") != 'visited')) {
    GLOBAL.showError("<a href='/politica.php'>Politicas</a> no cargadas, sin optimizar al 100%");
} else if ((localStorage.getItem("https://www.empire-strike.com/gobierno.php") != 'visited')) {
    GLOBAL.showError("<a href='/gobierno.php'>Mapa/Gobierno</a> no cargado, sin optimizar al 100%");
}*/
...
if ((localStorage.getItem("https://www.empire-strike.com/gobierno.php") != 'visited') && (localStorage.getItem("https://www.empire-strike.com/politica.php") != 'visited')) {
    GLOBAL.showError("<a href='/politica.php'>Politicas</a> y <a href='/gobierno.php'>Mapa/Gobierno</a> no cargados, sin optimizar al 100%", document.querySelector('.error-container'));
} else if ((localStorage.getItem("https://www.empire-strike.com/politica.php") != 'visited')) {
    GLOBAL.showError("<a href='/politica.php'>Politicas</a> no cargadas, sin optimizar al 100%", document.querySelector('.error-container'));
} else if ((localStorage.getItem("https://www.empire-strike.com/gobierno.php") != 'visited')) {
    GLOBAL.showError("<a href='/gobierno.php'>Mapa/Gobierno</a> no cargado, sin optimizar al 100%", document.querySelector('.error-container'));
}
...
/*function showError(msg, time) {
    ...
    // Encuentra el elemento con la clase 'minipapiro'
    var targetElement = document.querySelector(".minipapiro");

    // Si el elemento existe, inserta el mensaje a la derecha
    if (targetElement) {
        if (targetElement.parentNode) {
            targetElement.parentNode.insertBefore(mensajeError, targetElement.nextSibling);
        }
    } else {
        // Si no encuentras el elemento, inserta el mensaje al principio del contenido como antes
        document.getElementById("contenido").prepend(mensajeError);
    }

    if (time !== undefined) {
        setTimeout(function() {
            var mensajes = document.querySelectorAll(".mensajeOk");
            mensajes.forEach(function(obj) {
